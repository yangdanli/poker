window.onload=function(){
    ...
    var fn=function(){
        ...
        for(var i=0;i<7;i++){
            for(var j=0;j<i+1;j++){
                ...
                block.style.boxShadow='0 0 10px black inset';
                block.style.top=i*40+'px';
                block.style.left=(6-i)*160/2+j*160+'px';
                block.style.animation="rotateOut 1s";
    ...
    // btn1.innerHTML='下一张';
    btn1.style.backgroundImage='url(./images/11.png)';
    ...
    // btn2.innerHTML='重来';
    btn2.style.backgroundImage='url(./images/22.png)';
